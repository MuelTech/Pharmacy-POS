...
import { FaUser, FaLock, FaPills, FaExclamationTriangle, FaExclamationCircle, FaShieldAlt, FaCheckCircle } from 'react-icons/fa';
        ...
        <Card className="login-card shadow-lg">
          <Card.Body className="p-5">
            ...
            <div className="text-center mb-4">
              ...
              <h2 className="app-title">PharmaJiniper</h2>
              <p className="app-subtitle">Pharmacy Management System</p>
            </div>
